  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://157.241.58.61:1337/api/products",
        formPayload,
        {
          headers: {
      ...
      setError("Failed to add the listinings. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">
        Add New Add Furniture, Home & Garden
      </h1>
...
export default AddFurnitureHomeGarden;
