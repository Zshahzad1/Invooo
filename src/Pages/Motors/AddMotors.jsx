 ...
 if (name.startsWith("location.")) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Failed to add the motor. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Add New Motor</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col">
          ...
          {/* Posted By (User ID) */}
      <div className="flex flex-col">
        <label htmlFor="postedBy" className="mb-2 font-semibold text-gray-700">
          Posted By (User ID)
        </label>
        <select
          name="postedBy"
